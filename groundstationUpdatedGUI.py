"""
xbee_dashboard.py
(Upgraded with Matplotlib plots for EKF visualization)
"""
...
GUI_UPDATE_PERIOD = 100 # Update GUI 10 times a second (100ms)
...
class XBeeDashboard(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self.columnconfigure(0, weight=1)   # Left column (telemetry)
        ...
        # Method 1 (Display Units to the Right)
        ...
        # ttk.Label(self.telemetryEKFFrame, text=(f'{str(self.telemetryEkfPosNVar.get())} m')).grid(column=1, row=0, sticky="w")
        # ttk.Label(self.telemetryEKFFrame, text=(f'{str(self.telemetryEkfPosEVar.get())} m')).grid(column=1, row=1, sticky="w")
        # ttk.Label(self.telemetryEKFFrame, text=(f'{str(self.telemetryEkfVelNVar.get())} m/s')).grid(column=1, row=2, sticky="w")
        # ttk.Label(self.telemetryEKFFrame, text=(f'{str(self.telemetryEkfVelEVar.get())} m/s')).grid(column=1, row=3, sticky="w")
        # ttk.Label(self.telemetryEKFFrame, text=(f'{str(self.telemetryEkfBiasVar.get())} °')).grid(column=1, row=4, sticky="w")
        ...
        # ttk.Label(self.telemetryRawGPSFrame, text=(f'{str(self.telemetryRawGPSLatVar.get())}°')).grid(column=1, row=0, sticky="w")
        # ttk.Label(self.telemetryRawGPSFrame, text=(f'{str(self.telemetryRawGPSLonVar.get())}°')).grid(column=1, row=1, sticky="w")
        # ttk.Label(self.telemetryRawGPSFrame, text=(f'{str(self.telemetryRawGPSSpeedVar.get())}m/s')).grid(column=1, row=2, sticky="w")
        # ttk.Label(self.telemetryRawGPSFrame, text=(f'{str(self.telemetryRawGPSHeadVar.get())}°')).grid(column=1, row=3, sticky="w")
        # self.telemetryRawGPSFrame.columnconfigure(1, weight=1)
        # Method 2:
        ttk.Label(self.telemetryRawGPSFrame, text='Raw Lat (°): ').grid(column=0, row=0, sticky="e")
        ttk.Label(self.telemetryRawGPSFrame, text='Raw Lon (°): ').grid(column=0, row=1, sticky="e")
        ttk.Label(self.telemetryRawGPSFrame, text='Raw Speed (m/s): ').grid(column=0, row=2, sticky="e")
        ttk.Label(self.telemetryRawGPSFrame, text='Raw COG (°): ').grid(column=0, row=3, sticky="e")
        ...
        # ttk.Label(self.telemetryFusedFrame, text=(f'{str(self.telemetryFusedLatVar.get())}°')).grid(column=1, row=0, sticky="w")
        # ttk.Label(self.telemetryFusedFrame, text=(f'{str(self.telemetryFusedLonVar.get())}°')).grid(column=1, row=1, sticky="w")
        # ttk.Label(self.telemetryFusedFrame, text=(f'{str(self.telemetryFusedHeadVar.get())}°')).grid(column=1, row=2, sticky="w")
        ...
        # ttk.Label(self.telemetryAttitudeFrame, text=(f'{str(self.rollVar.get())}°')).grid(column=1, row=0, sticky="w")
        # ttk.Label(self.telemetryAttitudeFrame, text=(f'{str(self.pitchVar.get())}°')).grid(column=1, row=1, sticky="w")
        # ttk.Label(self.telemetryAttitudeFrame, text=(f'{str(self.yawVar.get())}°')).grid(column=1, row=2, sticky="w")
        ...
        # ttk.Label(self.telemetryGyroFrame, text=(f"{str(self.gyroXVar.get())}°/s")).grid(column=1, row=0, sticky="w")
        # ttk.Label(self.telemetryGyroFrame, text=(f"{str(self.gyroYVar.get())}°/s")).grid(column=1, row=1, sticky="w")
        # ttk.Label(self.telemetryGyroFrame, text=(f"{str(self.gyroZVar.get())}°/s")).grid(column=1, row=2, sticky="w")
        ...
        # ttk.Label(self.telemetryAccelFrame, text=((f"{str(self.accelXVar.get())}m/s²"))).grid(column=1, row=0, sticky="w");
        # ttk.Label(self.telemetryAccelFrame, text=((f"{str(self.accelYVar.get())}m/s²"))).grid(column=1, row=1, sticky="w");
        # ttk.Label(self.telemetryAccelFrame, text=((f"{str(self.accelZVar.get())}m/s²"))).grid(column=1, row=2, sticky="w");
        ...
        middle.grid(column=1, row=1, sticky="nsew", padx=8) # Use column 1
    ...
    def _rxSensorData(self):
        ...
        self._log(f"RX: Fused H={payload[2]:.1f}° | Bias={payload[7]:.4f} | Pos N={payload[3]:.1f} E={payload[4]:.1f}")
